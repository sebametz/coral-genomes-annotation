...
singularity exec --bind $WORK_DIR:$HOME,/lustre/scratch124/tol/teams/tolengine_guest/projects/coral_annotation/db:/protdbs docker://teambraker/braker3:latest braker.pl --genome=$TOLID.fa.masked --prot_seq=/protdbs/$DB --threads=$CPUS --workingdir=BRAKER3 --species=$TOLID --busco_lineage=$ORTHODB --crf
