# Files for jaDunAxif1

* braker.codingseq.gz - coding seqs from BRAKER3 predictions
* braker.aa.gz - proteins from BRAKER3 predictions
* braker.gtf.gz - GTF style annotation
* jaDunAxif1.emapper.decorated.gff.gz - GFF style annotation with EggNOG-mapper decoration
* jaDunAxif1.emapper.annotation.gz - EggNOG-mapper annotation output
...
<p align="center">
  <img src="jaDunAxif1_busco.jpeg" width="800"/>
</p>
